...
public interface DoctorRepository extends JpaRepository<DoctorEntity, Long>, JpaSpecificationExecutor<DoctorEntity> {
    ...
    @Query("SELECT d FROM DoctorEntity d LEFT JOIN FETCH d.doctorAbout LEFT JOIN FETCH d.doctorSpecializations ds LEFT JOIN FETCH ds.specialization WHERE d.status = 1")
