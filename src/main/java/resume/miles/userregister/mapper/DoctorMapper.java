...
public class DoctorMapper {
    ...
    public static DoctorDto toDto(UserEntity entity) {
    ...
    public static DoctorDto toDtoProfile(UserEntity entity) {
        if (entity == null) return null;
    ...
    public static UserEntity toEntity(DoctorDto dto) {
    ...
    public static UserEntity toEntityReg(String mobile) {
           UserEntity doc = UserEntity.builder()
                              .firstName("goodmood")
                              .lastName("doctor")
                              .adminStatus(0)
                              .isDeleted(0)
